...
async function init() {
  ...
  if (photographers && photographers.length && media && media.length > 0) {
    ...
    boutonTri.setAttribute("class", "btn-tri");
    boutonTri.setAttribute("aria-label", "Trier les médias");
    boutonTri.textContent = "Trier par nom";
    mediaSection.appendChild(boutonTri);
    ...
    const sortedMedia = sortMedia(filteredMedia, "popularity");
